function handle_form_behavior(){
    ...
    const the_select = document.querySelector('[data-id="select-contact-method"]');
    // const the_email_heading = document.getElementById('email-heading');
    const the_email = document.getElementById('mce-EMAIL');
    const the_email_control = document.getElementById('email-control');
    const the_phone = document.getElementById('mce-PHONE');
    ...
    const random_email = 'random-' + random_string + '@secariolabs.com';
    ...
    the_select.addEventListener('change', (event) => {
        ...
        if(the_value == 'phone') {
            the_email.value = random_email;
            // the_email.required = false;
            the_email_control.classList.add('hidden--important');
            
            the_phone.required = true;
            // time_to_call.required = true;
            the_phone_control.classList.remove('hidden--important');
            // time_to_call_control.classList.remove('hidden--important');
        }
        ...
        if(the_value == 'email') {
            ...
            the_phone_control.classList.add('hidden--important');
            // time_to_call_control.classList.add('hidden--important');

            // the_email.required = true;
            // the_email_heading.classList.remove('hidden');
            the_email_control.classList.remove('hidden--important');
        }
